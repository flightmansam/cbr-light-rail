...
import { ToggleButton as MuiToggleButton, Button, ButtonGroup, Divider, Stack, ThemeProvider, createTheme, styled, Link, Typography } from "@mui/material";
...
function Menu() {
    ...
    return (
        ...
        <Typography variant="body1">
            ...
            On the display the current locations of light rails vehicles are displayed with yellow dots.
        ...
        <Divider>Station Selection</Divider>
        <ButtonGroup 
            orientation="vertical"
            variant="contained" 
        ...
        <Typography variant="body1">
            ...
            however I have made my own modifications because... I can! This web app is 
        ...
        <Link href="https://github.com/flightmansam/cbr-light-rail-react">Link the web app</Link>
        <Link href="https://github.com/flightmansam/cbr-light-rail-data">Link to my data API</Link>
        <Link href="https://github.com/flightmansam">Link to me!</Link>
        
        <Typography variant="body1">
            Ver. 1.1 - 22nd Feb</Typography>
